...
export default async function MatchDetailPage({
  ...
  const scoreLabel = match.phase === "group_stage" ? "Final 90 min" : "Resultado global";
  const predictionHelp =
    match.phase === "group_stage"
      ...
      : "Completa tu jugada antes de que cierre el partido. Elige quién avanza y agrega el marcador global obligatorio.";
          ...
          <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3">
            ...
            {showFinalScore ? (
              <div className="grid place-items-center">
                ...
                <span className="mt-1 text-xs font-bold text-white/45">{scoreLabel}</span>
              </div>
            ) : (
